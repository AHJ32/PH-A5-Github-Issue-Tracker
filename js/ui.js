// GitHub Issues Tracker — UI helpers v1774705237990
  ...
  export function buildModal(issue) {
    ...
    var statusBg = isOpen ? "bg-green-100 text-green-700" : "bg-purple-100 text-purple-700";
    ...
    return (
      '<div class="border-t-4 ' + borderColor + ' pt-4">' +
        ...
        "</div>" +
        '<h2 class="text-[1.1rem] font-bold text-[#1F2937] mb-2">' + (issue.title || "Untitled") + "</h2>" +
        '<p class="text-[#475569] text-sm mb-4 leading-relaxed">' + (issue.description || "") + "</p>" +
        '<div class="flex flex-wrap gap-1 mb-4">' + labelPills(issue.labels || issue.label) + "</div>" +
        '<div class="grid grid-cols-2 gap-3 text-sm">' +
          '<div class="bg-[#f8fafc] rounded-lg p-3"><span class="text-[#94a3b8] text-xs uppercase font-semibold block mb-1">Author</span><span class="text-[#1F2937] font-medium">' + (issue.author || "Unknown") + "</span></div>" +
          '<div class="bg-[#f8fafc] rounded-lg p-3"><span class="text-[#94a3b8] text-xs uppercase font-semibold block mb-1">Priority</span><span class="text-[#1F2937] font-medium">' + (issue.priority || "N/A") + "</span></div>" +
          '<div class="bg-[#f8fafc] rounded-lg p-3"><span class="text-[#94a3b8] text-xs uppercase font-semibold block mb-1">Labels</span><span class="text-[#1F2937] font-medium">' + (labels.join(", ") || "N/A") + "</span></div>" +
          '<div class="bg-[#f8fafc] rounded-lg p-3"><span class="text-[#94a3b8] text-xs uppercase font-semibold block mb-1">Created At</span><span class="text-[#1F2937] font-medium">' + formatDate(issue.createdAt) + "</span></div>" +
        "</div>" +
